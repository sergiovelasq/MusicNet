...
def crearpanellogin(ventana, f1, f2):
    
    login=Frame(ventana, width=800, height=400)
    login.pack()
    login=Label(login, text="MusicNet", fg="black", font=("Baskerville Old Face", 20)).place(x=350, y=10)
...
def iniciaracceder(principal):
    ...
    crearpanellogin(acceder, registrarse, volver, iniciarsesion, accedercomocliente)
